...
// To compile: (tested under Ubuntu 24.04)
// Use system package manager to install libraries: mlpack and boost (libmlpack-dev, libboost-all-dev, libensmallen-dev)
// compile & link by command: g++ -std=c++20 nl_shade_rsp_mid.cpp RB_cec22_test_func.cpp -lboost_program_options -Os
...
using mlpack::KMeans;
using mlpack::EuclideanDistance;
using mlpack::SilhouetteScore;
...
if(populLimCount[curIndx]>MIN_ITS_ON_BOUND){
    ...
    return;
        ...
        koniec pętli dla pojedynczego potomka
        #########################################################################################################
        int CHOSEN_INDX=0;
